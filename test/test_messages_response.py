...
import smtpcom
from smtpcom.models.messages_response import MessagesResponse  # noqa: E501
...
class TestMessagesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = smtpcom.models.messages_response.MessagesResponse()  # noqa: E501
        if include_optional :
            return MessagesResponse(
                status = '0', 
                data = smtpcom.models.messages_response_data.MessagesResponseData(
                    items = [
